<?php /*a:3:{s:77:"E:\php\PHPTutorial\WWW\yidong\application\admin\view\admindetails\picadd.html";i:1563084130;s:70:"E:\php\PHPTutorial\WWW\yidong\application\admin\view\public\_meta.html";i:1563324026;s:72:"E:\php\PHPTutorial\WWW\yidong\application\admin\view\public\_footer.html";i:1562634778;}*/ ?>
<!--_meat 作为公共模版分离出去-->	
	...
	<form class="layui-form" action="" method="post">
		<input type="hidden" name="did"  value="<?php echo htmlentities($id); ?>" />
	  	...
	  	<div class="layui-form-item">
		    <label class="layui-form-label">商品详情标题</label>
		    <div class="layui-input-block">
		    	<input type="text" name="title1"   autocomplete="off" placeholder="请输入图片标题" class="layui-input">
		    </div>
	  	</div>
	  	...
	  	<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		    	<input type="text" name="class"   autocomplete="off" placeholder="请输入图片种类" class="layui-input">
		    </div>
	  	</div>
	  	...
	  	<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		    	<input type="text" name="price1"   autocomplete="off" placeholder="请输入图片标题" class="layui-input">
		    </div>
	  	</div>
	  	...
	  	<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		    	<input type="text" name="inventory"   autocomplete="off" placeholder="请输库存" class="layui-input">
		    </div>
	  	</div>
	  	<!--<div class="layui-form-item">
 		...
 		<input type="hidden" name="img" id="uplode"  value="" />
  		<div class="layui-upload">
			  <button type="button" class="layui-btn" id="test2" data-img="<?php echo url('Admindetails/upload'); ?>">图片上传</button> 
		 ...
		 <div class="layui-form-item">
		    <div class="layui-input-block">
		      	<button class="layui-btn" lay-submit lay-filter="demo1" data-insert="<?php echo url('Admindetails/insert'); ?>" id="addBtn">立即提交</button>
		    </div>
		  </div>
