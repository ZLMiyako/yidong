<?php /*a:3:{s:74:"E:\php\PHPTutorial\WWW\yidong\application\admin\view\adminclass\index.html";i:1563331693;s:70:"E:\php\PHPTutorial\WWW\yidong\application\admin\view\public\_meta.html";i:1563324026;s:72:"E:\php\PHPTutorial\WWW\yidong\application\admin\view\public\_footer.html";i:1562634778;}*/ ?>
﻿<!--_meat 作为公共模版分离出去-->	
...
<body>
<!--<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 图片管理 <span class="c-gray en">&gt;</span> 图片列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="<?php echo url('Adminclass/index'); ?>;" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">-->
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="<?php echo url('Adminclass/deleALL'); ?>" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="picadd('添加商品详情','<?php echo url("Adminclass/picadd",["id"=>$id["id"]]); ?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加商品遍体</a></span></div>
	...
	<div class="mt-20">
		...
		<?php if(($alist != [])): if(is_array($alist) || $alist instanceof \think\Collection || $alist instanceof \think\Paginator): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$alist): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
					<td><input name="" type="checkbox" value=""></td>
					<td><?php echo htmlentities($alist['id']); ?></td>
					<td><?php echo htmlentities($alist['name']); ?></td>
					<td><?php echo htmlentities($alist['size']); ?></td>
					<td height="87"><a href="javascript:;" ><img width="70" class="picture-thumb" src="/yidong/public/uploads/<?php echo htmlentities($alist['img']); ?>"></a></td>
					<td><?php echo htmlentities($alist['time']); ?></td>
					<td class="td-manage"><a style="text-decoration:none" onClick="picture_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> <a style="text-decoration:none" class="ml-5" onClick="edit('图库编辑','<?php echo url("Adminclass/edit"); ?>',<?php echo htmlentities($alist['id']); ?>)" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="dele('图库删除','<?php echo url("Adminclass/dele"); ?>',<?php echo htmlentities($alist['id']); ?>)" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
