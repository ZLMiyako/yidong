<?php /*a:4:{s:74:"D:\phpstudy\PHPTutorial\WWW\yidong\application\admin\view\index\index.html";i:1563082431;s:75:"D:\phpstudy\PHPTutorial\WWW\yidong\application\admin\view\public\_meta.html";i:1563324026;s:77:"D:\phpstudy\PHPTutorial\WWW\yidong\application\admin\view\public\_header.html";i:1562308004;s:77:"D:\phpstudy\PHPTutorial\WWW\yidong\application\admin\view\public\_footer.html";i:1562634778;}*/ ?>
﻿<!--_meat 作为公共模版分离出去-->	
...
<!--_meat 作为公共模版分离出去-->	
<title><?php echo htmlentities($auser); ?></title>
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				<li><?php echo htmlentities($auser); ?></li>
				<li class="dropDown dropDown_hover">
					<a href="#" class="dropDown_A"><i class="Hui-iconfont">&#xe6d5;</i></a>
					<ul class="dropDown-menu menu radius box-shadow">
						<li><a href="javascript:;" onClick="myselfinfo()">个人信息</a></li>
						<li><a href="<?php echo url('Index/esc'); ?>">切换账户</a></li>
						<li><a href="<?php echo url('Index/esc'); ?>">退出</a></li>
				</ul>
			</li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo url('Adminpic/index'); ?>" data-title="轮播管理" >轮播管理</a></li>
					<!--<li><a data-href="<?php echo url('Pic/index'); ?>" data-title="图片管理" >图片管理</a></li>
					<li><a data-href="<?php echo url('Anews/index'); ?>" data-title="图片管理" >图片新闻管理</a></li>-->
				</ul>
		</dd>
	</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo url('Adminnav/index'); ?>" data-title="商品管理" href="javascript:void(0)">导航管理</a></li>
					<li><a data-href="<?php echo url('Adminproduct/index'); ?>" data-title="新闻管理" href="javascript:void(0)">商品管理</a></li>
					<li><a data-href="<?php echo url('Adminnews/index'); ?>" data-title="新闻管理" href="javascript:void(0)">新闻管理</a></li>
				</ul>
		</dd>
	</dl>
...
function myselfinfo(){
	layer.open({
		...
		shade:0.4,
		title: '查看信息',
		content: "<table style='margin: 20px auto;width:250px;text-align:center;'><tr><td>管理员名称</td><td>权限</td><td>操作</td></tr><tr><td>admin</td><td>无</td><td>无</td></tr></table>"
	});
}
