<?php /*a:3:{s:72:"E:\php\PHPTutorial\WWW\yidong\application\admin\view\adminnav\index.html";i:1563325028;s:70:"E:\php\PHPTutorial\WWW\yidong\application\admin\view\public\_meta.html";i:1563324026;s:72:"E:\php\PHPTutorial\WWW\yidong\application\admin\view\public\_footer.html";i:1562634778;}*/ ?>
﻿<!--_meat 作为公共模版分离出去-->	
...
<div class="page-container">
	<form action="javascript:;" method="post">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="<?php echo url('Adminnav/deleALL'); ?>" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="picadd('添加导航','<?php echo url("Adminnav/picadd"); ?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加导航</a></span> <span class="r">共有数据：<strong><?php echo htmlentities($count); ?></strong> 条</span> </div>
	</form>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			<thead>
				<tr class="text-c">
					...
					<th width="150">导航图标</th>
					<th width="200">导航地址</th>
			...
			<?php if(is_array($alist) || $alist instanceof \think\Collection || $alist instanceof \think\Paginator): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
					...
					<td><?php echo htmlentities($list['nav']); ?></td>
					<td><a href="javascript:;" ><img width="50" class="picture-thumb" src="/yidong/public/uploads/<?php echo htmlentities($list['img']); ?>"></a></td>
					<td><?php echo htmlentities($list['url']); ?></td>
					<td><?php echo htmlentities($list['time']); ?></td>
					<td class="td-manage"><a style="text-decoration:none" onClick="picture_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> <a style="text-decoration:none" class="ml-5" onClick="edit('图库编辑','<?php echo url("Adminnav/edit"); ?>',<?php echo htmlentities($list['id']); ?>)" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="dele('图库编辑','<?php echo url("Adminnav/dele"); ?>',<?php echo htmlentities($list['id']); ?>)" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
