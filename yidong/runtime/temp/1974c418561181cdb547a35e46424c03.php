<?php /*a:3:{s:75:"E:\php\PHPTutorial\WWW\yidong\application\admin\view\adminmessage\edit.html";i:1563086660;s:70:"E:\php\PHPTutorial\WWW\yidong\application\admin\view\public\_meta.html";i:1563324026;s:72:"E:\php\PHPTutorial\WWW\yidong\application\admin\view\public\_footer.html";i:1562634778;}*/ ?>
<!--_meat 作为公共模版分离出去-->	
	...
	<form class="layui-form" action="" method="post">
		<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		    	<input type="text" name="product"  value="<?php echo htmlentities($update['product']); ?>" autocomplete="off" placeholder="请输入产品号" class="layui-input">
		    </div>
	  	</div>
	  	...
	  	<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		    	<input type="text" name="name" value="<?php echo htmlentities($update['name']); ?>"  autocomplete="off" placeholder="请输入厂家名字" class="layui-input">
		    </div>
	  	</div>
	  	...
	  	<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		    	<input type="text" name="addres" value="<?php echo htmlentities($update['addres']); ?>"  autocomplete="off" placeholder="请输入厂家地址" class="layui-input">
		    </div>
	  	</div>
	  	...
	  	<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		    	<input type="text" name="phone" value="<?php echo htmlentities($update['phone']); ?>"  autocomplete="off" placeholder="请输厂家联系方式" class="layui-input">
		    </div>
	  	</div>
	  	...
	  	<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		    	<input type="text" name="burden" value="<?php echo htmlentities($update['burden']); ?>"  autocomplete="off" placeholder="请输配料表" class="layui-input">
		    </div>
	  	</div>
	  	...
	  	<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		    	<input type="text" name="storage" value="<?php echo htmlentities($update['storage']); ?>"  autocomplete="off" placeholder="储存方法" class="layui-input">
		    </div>
	  	</div>
	  	...
	  	<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		    	<input type="text" name="expiration"  value="<?php echo htmlentities($update['expiration']); ?>" autocomplete="off" placeholder="保质期" class="layui-input">
		    </div>
	  	</div>
	  	...
	  	<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		    	<input type="text" name="taste" value="<?php echo htmlentities($update['taste']); ?>"  autocomplete="off" placeholder="口味" class="layui-input">
		    </div>
	  	</div>
		 ...
		 <div class="layui-form-item">
		    <div class="layui-input-block">
		      	<button class="layui-btn" lay-submit lay-filter="demo1" data-insert="<?php echo url('Adminmessage/update'); ?>" id="addBtn">立即提交</button>
		    </div>
		  </div>
